...
- テーマカラーの背景色＋左ボーダー（`border-l-4`）を行全体に適用（テーマ依存）
  - ライト: `bg-blue-50 border-blue-400` / ダーク: `bg-blue-900 border-blue-500`
  - ナチュラル: `bg-amber-100 border-amber-500` / パステル: `bg-yellow-100 border-yellow-400`
- オレンジ色の全体枠（`border-2 border-orange-400`、絶対配置オーバーレイ）を上から重ねて表示
- オレンジ枠はテーマに関わらず固定
...
*作成日: 2026-06-03 / 最終更新: 2026-06-10*
